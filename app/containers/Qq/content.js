export const zhContent = {
  ...
  left_top_column: {
    ...
    img1: { src: 'https://s3.ap-northeast-2.amazonaws.com/marcus-thesis/qq/1.png', text: '四川九寨沟现壮美蓝色冰瀑 犹如天然雕塑' },
    ...
    img2: { src: 'https://s3.ap-northeast-2.amazonaws.com/marcus-thesis/qq/2.png', text: '俄战机飞行员最后时刻疑曝光：高喊“为了兄弟”' },
    text3: ['云南越狱犯张林苍被判无期 曾当庭自曝“杀人”', '凉山男孩雪中背弟弟 200米落差山路走50分钟', '“超级碗”比赛后美国费城发生爆炸 街上逾10万人', '高铁因等待下连新兵延时十分钟发车 旅客积极响应', '情侣登山事件救援人员：遇难女子男友尽力了', '全球第一白富美恋爱了 不仅是学霸还是马术冠军', '《假如动物会摄影》吴秀波配音“表白”黑猩猩', '苹果收到数百份投诉：iPhone X竟然接不了电话？', '81岁“学霸奶奶”大学毕业：只要学习我就高兴'],
  },
  mid_top_column: {
    header1: '今日话题',
    ...
    many_img1: { header: '今日热门视频', src1: 'https://s3.ap-northeast-2.amazonaws.com/marcus-thesis/qq/3.png', src1_text: '吴秀波配音表白黑猩猩', src2: 'https://s3.ap-northeast-2.amazonaws.com/marcus-thesis/qq/4.png', src2_text: '打工女孩哭诉生活不易' },
    header2: '',
    ...
    many_img2: { header: '今日图话', src1: 'https://s3.ap-northeast-2.amazonaws.com/marcus-thesis/qq/5.png', src1_text: '工程师返乡种水果又考博', src2: 'https://s3.ap-northeast-2.amazonaws.com/marcus-thesis/qq/6.png', src2_text: '真美人无惧皱纹' },
  ...
  left_category_column1: {
    header: '财经 / 证券 / 理财',
    img: { src: 'https://s3.ap-northeast-2.amazonaws.com/marcus-thesis/qq/7.png', text: '人民币对美元累计升值3.76% 专家：节前易升难贬' },
  ...
  mid_category_column1: {
    header: '',
    img: { src: 'https://s3.ap-northeast-2.amazonaws.com/marcus-thesis/qq/8.png', text: '道指周五暴跌近700点 为什么没有触发熔断机制？' },
  ...
  right_category_column1: {
    header: '汽车 / 在线购车',
    img: { src: 'https://s3.ap-northeast-2.amazonaws.com/marcus-thesis/qq/9.png', text: '冰雪路面全能之选 豪华全时四驱SUV推荐' },
  ...
  left_category_column2: {
    header: '体育 / NBA / 英超 / 搏击',
    img: { src: 'https://s3.ap-northeast-2.amazonaws.com/marcus-thesis/qq/10.png', text: 'NFL-老鹰首夺超级碗 布雷迪致命失误无缘第6冠' },
  ...
  right_category_column2: {
    header: '房产 / 腾讯看房',
    img: { src: 'https://s3.ap-northeast-2.amazonaws.com/marcus-thesis/qq/11.png', text: '返乡置业还是继续观望，未来楼市怎么走？' },
...
export const enContent = {
  ...
  main_header: {
    box1: {
      ...
      row2: ['Finance', 'Security', 'Market'],
    },
    box2: {
      row1: ['Video', 'Popular', 'Variety'],
      row2: ['Sport', 'NBA', 'CBA'],
    },
    box3: {
      row1: ['Gossip', 'Celebrity', 'Movies'],
  ...
  mid_category_column2: {
    header: '',
    text: ['Tencent Winter Olympics team set off hundreds of teams to create more than 30 files original content', 'Jia singing during Super Bowl, midfielder Xiu Jin song and dance stuns the audience', 'Eagle won, Bryan can be left out today', 'Point of view: Do not ruin the world first league video referee in the Premier League', 'The World Cup -9 minutes 5 goal, Poland 9th top team in Eastern Europe', 'Tottenham coach: We show too much weakness to Liverpool', 'Brothers say! Old horse to Li root: Thank you for helping me win the championship'],
  },
  right_category_column2: {
    header: 'Real Estate',
